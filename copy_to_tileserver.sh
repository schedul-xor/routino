...
scp routino/xml/routino-custom-profiles.xml routino/xml/routino-translations.xml xor@${TILE0_HOST}:~/Documents/routino/xml/
...
scp routino/xml/routino-custom-profiles.xml routino/xml/routino-translations.xml xor@${TILE1_HOST}:~/Documents/routino/xml/
